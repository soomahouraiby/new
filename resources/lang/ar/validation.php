...
return [
    ...
    'attributes'           => [
        ...
        'weight'                => 'وزن',
        'length'                => 'الطول',
        'methodobtaining'       => ' الحصلت على المستحضر',
        'facilityaddress'       => 'عنوان المنشأة',
        'startusingdate'        => 'تاريخ بدء الاستخدام',
        'takedrug'              => 'طريقة تناول الدواء',
        'purposeuse'            => 'الغرض من استخدامه',
        'dosage'                => 'الجرعة',
        'stoppedusingdate'      => 'تاريخ الصالحية',
        'stoppedusing'         => 'توقف عن الاستخدام',
        'describeproblem'      => 'وصف المشكلة',
        'facilityname'         => 'إسم المنشأة',
        'startsideeffect'      => 'تاريخ بدء ظهور العرض الجانبي',
        'severity'             => 'مدى خطورة الدواء ',
        'sideshowstill'        => 'هل زال العرض الجانبي',
        'dateendside'          => ' تاريخ انتهاء الاعراض الجانبية',
        'patientcondition'     => 'حالة المريض حاليا',
        'informdoctor'         => 'إبلاغ الطبيب أو الصيدلي ',
