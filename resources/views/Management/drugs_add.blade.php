...
@section('content')
    ...
    <main >
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 pr-2  border-bottom main " >
            <h1 class="h2  ml-4"> اضافة دواء</h1>
        ...
        <div class="card shadow mb-0 pb-0" >
            ...
            <form   action="{{route('drugs_insert')}}"  method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row pb-5 ">
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input name="register_no" type="number" class="form-control"   required min="1" max="20000000000" >
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="how_use" required type="date" class="form-control"></textarea>
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="prevents_use" required type="date" class="form-control"></textarea>
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea  name="side_effects"  required   class="form-control" ></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="imge-file text-center" style=" position: relative; ">
                                        ...
                                        <img id="profile_image" width="150"  style="visibility: hidden;">
                                    </div>
                                    @if($errors->has('photo'))
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control " required name="company_id"  id="company_id" >  </select>
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control " required name="agent_id"  id="agent_id" >  </select>
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control " required name="material_id[]" multiple="multiple"  id="material_id" >  </select>
                        ...
                        <div class="form-group col-lg-6 raw mt-4 " >
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control " required name="diseases_id[]" multiple="multiple"  id="diseases_id" >  </select>
    ...
    document.getElementById('uploadFile').addEventListener('change', function (){
            ...
            if (/^image/.test( files[0].type)){ // only image file
                ...
                //    myInout.parentElement.firstElementChild.style.backgroundImage =  "url("+this.result+")";
                   ...
                   document.getElementById('profile_image').style.visibility = 'visible';
