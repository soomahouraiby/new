    ...
    <div class="position-fixed pt-4  border-bottom">
        @if(auth()->user()->hasRole('مدير العمليات'))
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('OP_Reports')}}">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('PM_drug')}}">
                        ...
                        <span data-feather="file" class="ml-2">ادارة الادوية</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        @elseif(auth()->user()->hasRole('المدير العام'))
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active " aria-current="page" href="{{route('all_drugs')}}">
                    ...
                    <ul class="UL">
                        <li class="nav-item " >
                            <a class="nav-link active " aria-current="page" href="{{route('all_companies')}}">
                                <i class="far fa-building"></i>
                                <span data-feather="file" class="ml-2">ادارة الشركات</span>
                            </a>
                        </li>
                        <li class="nav-item " >
                            <a class="nav-link active " aria-current="page" href="{{route('all_agents')}}">
                                <i class="far fas fa fa-magnet"></i>
                                <span data-feather="file" class="ml-2">ادارة الوكلاء</span>
                            </a>
                        </li>
                        <li class="nav-item " >
                            <a class="nav-link active " aria-current="page" href="{{route('all_effective_materials')}}">
                                <i class="far fas fa fa-bahai"></i>
                                <span data-feather="file" class="ml-2">ادارة المواد الفعالة</span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('batch_numbers')}}">
                        <i class="fas fa-truck"></i>
                        <span data-feather="file" class="ml-2">ادارة الدفعات</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">
