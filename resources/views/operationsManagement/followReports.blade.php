                            ...
                            @if(isset($reports2))
                                @foreach($reports2 as $report2)
                                    <tr class="btn-reveal-trigger">
                                        ...
                                        <td class="align-middle white-space-nowrap text-left name "><a >{{$report2 -> amount_name}}</a></td>
                                        <td class="align-middle white-space-nowrap text-left email"><a>{{$report2 -> date}}</a></td>
                                        <td class="align-middle white-space-nowrap text-left product"><a >{{$report2-> transfer_date}}</a></td>
                                        <td class="align-middle white-space-nowrap text-left amount"><a >{{$report2 -> transfer_party}}</a></td>
                                        @if($report2->report_statuses=='قيد المتابعة')
                                            <td class="align-middle text-left  white-space-nowrap payment">
                                                <a class="badge badge rounded-pill badge-soft-success  align-items-center text-left nav-link active" href="{{route('OP_followedUp',$report2 -> id)}}" style="background-color:#FDE6D8; color:#A7613A;  height:25px;"  >
                                                    <span data-feather="file  text-center">{{$report2 -> report_statuses}}</span>
                                                    <i class="fas fa-file-contract ml-3"></i>
                                                </a>
                                            </td>
                                            <td class="align-middle white-space-nowrap">
                                                <div class="dropdown font-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right border py-2" aria-labelledby="dropdown0">
                                                        <a class="dropdown-item" href="{{route('OP_followedUp',$report2 -> id)}}">عرض</a>
                                                    </div>
                                                </div>
                                            </td>
                                        @elseif($report2->report_statuses=='تمت المتابعة')
                                            <td class="align-middle text-left  white-space-nowrap payment">
                                                <a class="badge badge rounded-pill badge-soft-success  align-items-center text-left nav-link active" href="{{route('OP_followedUp',$report2 -> id)}}" style="background-color:#D9DEFF; color:#5468FF;  height:25px;"  >
                                                    <span data-feather="file  text-center">{{$report2 -> report_statuses}}</span>
                                                    <i class="fas fa-file-contract ml-3"></i>
                                                </a>
                                            </td>
                                                    ...
                                                    <div class="modal fade " id="myModal">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="{{route('OP_saveOPMNotes',$report2 -> id)}}">
                                                                        @csrf
                                                                        <div class=" mt-2 col-lg-12 ">
                                                                            <textarea class="form-control" name="opmanage_notes"  rows="3" ></textarea>
                                                                        </div>
                                        ...
                                        @elseif($report2->report_statuses=='محول للمتابعة')
                                            <td class="align-middle text-left  white-space-nowrap payment">
                                                <a class="badge badge rounded-pill badge-soft-success  align-items-center text-left nav-link active" href="{{route('OP_followedUp',$report2 -> report_no)}}" style="background-color:#E3E6EA; color:#7D899B;  height:25px;"  >
                                                    <span data-feather="file  text-center">{{$report2 -> report_statuses}}</span>
                                                    <i class="fas fa-file-contract ml-3"></i>
                                                </a>
                                            </td>
                                        ...
                                        @elseif($report2->report_statuses=='تم الانهاء')
                                            <td class="align-middle text-left  white-space-nowrap payment">
                                                <a class="badge badge rounded-pill badge-soft-success  align-items-center text-left nav-link active" href="{{route('OP_followedUp',$report2 -> report_no)}}" style="background-color:#CCF6E4; color:#00864E;  height:25px;"  >
                                                    <span data-feather="file  text-center">{{$report2 -> report_statuses}}</span>
                                                    <i class="fas fa-check-circle ml-3"></i>
                                                </a>
                                            </td>
